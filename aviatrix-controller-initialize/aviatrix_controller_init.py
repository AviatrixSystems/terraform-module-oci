...
def function_handler(event):
    ...
    oci_tenancy_id = event["oci_tenancy_id"]
    oci_user_id = event["oci_user_id"]
    oci_compartment_id = event["oci_compartment_id"]
    oci_api_key_path = event["oci_api_key_path"]
    ...
    # Step11. Create Access Account Based on OCI
    logging.info("START : Create the Access Account based on OCI")
    ...
    logging.info("END : Create the Access Account based on OCI")
...
if __name__ == "__main__":
    ...
    oci_tenancy_id = sys.argv[5]
    oci_user_id = sys.argv[6]
    oci_compartment_id = sys.argv[7]
    oci_api_key_path = sys.argv[8]
